...
def rutina_step_plot(self, system, T):
    ...
    with open('Set1Step.pkl', 'wb', ) as f:
        pickle.dump([t, y], f)
...
def rutina_bode_plot(self, system):
    ...
    with open('Set1Bode.pkl', 'wb', ) as f:
        pickle.dump([omega, bodeDb, phase * 180.0 / np.pi], f)
    with open('Set1Margin.pkl', 'wb', ) as f:
        pickle.dump([gm, pm, wg, wp], f)
...
def rutina_nyquist_plot(self, system):
    ...
    with open('Set1Nyquist.pkl', 'wb', ) as f:
        pickle.dump([real, imag, freq], f)
...
def rutina_root_locus_plot(self, system):
    ...
    with open('Set1Rlocus.pkl', 'wb', ) as f:
        pickle.dump([t, y], f)
    return
...
def rutina_nichols_plot(self, system):
    ...
    with open('Set1Nichols.pkl', 'wb', ) as f:
        pickle.dump([t, y], f)
    return
...
def rutina_system_info(self, system, T, mag, phase, omega):
    ...
    with open('Set1Datos.pkl', 'wb', ) as f:
        pickle.dump(Datos, f)
    return
