...
MatFileMATLAB = io.loadmat('comparisonFiles/Data MATLAB/Simulacion/PDG11', squeeze_me=True)
MatFileSciLab = io.loadmat('comparisonFiles/Data SciLab/Simulacion/PDGc11', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Simulacion/Controlador14.pkl', 'rb') as f:
...
ax.plot(t_comun, yout_lv, 'r', dashes=[1, 2], label='LV/Fehlberg4(5) con filtro', linewidth=3)
ax.plot(t_comun, yout_sci, color="#12711C", dashes=[2, 2], label='SciLab/BDF-Newton', linewidth=2)
ax.set_title('Controlador PID con programador de ganancias difuso', fontsize=11)
...
axins.set_ylim(YMIN[index_min] - 0.05,
               YMAX[index_max] + 0.05)

ax.indicate_inset_zoom(axins)
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Simulacion/PDGc1.pdf')
plt.show()