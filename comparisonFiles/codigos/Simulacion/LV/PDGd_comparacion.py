...
MatFileMATLAB = io.loadmat('comparisonFiles/Data MATLAB/Simulacion/PDGd8', squeeze_me=True)
MatFileSciLab = io.loadmat('comparisonFiles/Data SciLab/Simulacion/PDGd8', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Simulacion/ControladorD8.pkl', 'rb') as f:
