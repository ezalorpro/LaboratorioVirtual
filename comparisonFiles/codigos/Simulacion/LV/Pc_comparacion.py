...
MatFileMATLAB = io.loadmat('comparisonFiles/Data MATLAB/Simulacion/Pc1', squeeze_me=True)
MatFileSciLab = io.loadmat('comparisonFiles/Data SciLab/Simulacion/Pc1', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Simulacion/Controlador1.pkl', 'rb') as f:
...
axins.grid()
axins.set_xlim(t_comun[index_max] - 0.2, t_comun[index_min] + 0.1)
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Simulacion/Pc.pdf')
plt.show()