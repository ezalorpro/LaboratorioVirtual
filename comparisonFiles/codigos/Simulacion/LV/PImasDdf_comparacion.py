...
MatFileMATLAB = io.loadmat('comparisonFiles/Data MATLAB/Simulacion/PImasDdf6', squeeze_me=True)
MatFileSciLab = io.loadmat('comparisonFiles/Data SciLab/Simulacion/PImasDdf6', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Simulacion/ControladorD6.pkl', 'rb') as f:
...
axins = ax.inset_axes([0.24, 0.08, 0.24, 0.2], alpha=0.4)
...
axins.grid()
axins.set_xlim(t_comun[index_max] - 0.25, t_comun[index_min] + 0.25)
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Simulacion/PImasDd.pdf')
plt.show()