...
MatFileMATLAB = io.loadmat('comparisonFiles/Data MATLAB/Simulacion/Pd1', squeeze_me=True)
MatFileSciLab = io.loadmat('comparisonFiles/Data SciLab/Simulacion/Pd1', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Simulacion/ControladorD1.pkl', 'rb') as f:
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Simulacion/Pd.pdf')
plt.show()