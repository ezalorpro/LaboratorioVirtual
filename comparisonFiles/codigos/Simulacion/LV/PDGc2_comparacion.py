...
MatFileMATLAB = io.loadmat('comparisonFiles/Data MATLAB/Simulacion/PDG12', squeeze_me=True)
MatFileSciLab = io.loadmat('comparisonFiles/Data SciLab/Simulacion/PDGc12', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Simulacion/Controlador15.pkl', 'rb') as f:
...
axins.grid()
axins.set_xlim(t_comun[index_max] - 0.3, t_comun[index_min] + 0.5)
