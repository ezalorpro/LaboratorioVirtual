...
MatFileMATLAB = io.loadmat('comparisonFiles/Data MATLAB/Simulacion/PIDcf5', squeeze_me=True)
MatFileSciLab = io.loadmat('comparisonFiles/Data SciLab/Simulacion/PIDcf5', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Simulacion/Controlador6.pkl', 'rb') as f:
...
# axins = ax.inset_axes([0.55, 0.52, 0.4, 0.25])
...
# axins.set_ylim(YMIN[index_min] - 0.05, YMAX[index_max] + 0.05)
