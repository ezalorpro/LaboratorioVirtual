...
MatFileMATLAB = io.loadmat('comparisonFiles/Data MATLAB/Simulacion/PIDd3', squeeze_me=True)
MatFileSciLab = io.loadmat('comparisonFiles/Data SciLab/Simulacion/PIDd3', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Simulacion/ControladorD3.pkl', 'rb') as f:
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Simulacion/PIDd.pdf')
plt.show()