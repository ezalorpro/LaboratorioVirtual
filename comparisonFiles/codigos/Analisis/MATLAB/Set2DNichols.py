...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S2DNichols', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Analisis/Set2DNichols.pkl', 'rb') as f:
...
mask3 = Db1[mask1][mask2] >= -47
WN1 = WN1[mask1][mask2][mask3]
Pha1 = Pha1[mask1][mask2][mask3]
Db1 = Db1[mask1][mask2][mask3]
...
axins = ax.inset_axes([0.15, 0.17, 0.4, 0.33])
...
x1, x2 = Pha1[indice] - np.abs(Db1[indice] - Db2[indice])*0.2, Pha2[indice] + np.abs(Db1[indice] - Db2[indice])*0.2
...
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set2DNichols.png', dpi=200)
plt.show()
