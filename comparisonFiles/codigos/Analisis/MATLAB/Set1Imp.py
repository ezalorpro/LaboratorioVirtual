...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S1Imp', squeeze_me=True)
...
axins = ax.inset_axes([0.54, 0.3, 0.41, 0.4])
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set1Imp.png', dpi=200)
plt.show()
