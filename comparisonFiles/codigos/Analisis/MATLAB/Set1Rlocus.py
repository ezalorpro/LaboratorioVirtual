...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S1Rlocus', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Analisis/Set1Rlocus.pkl', 'rb') as f:
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set1Rlocus.png', dpi=200)
plt.show()
