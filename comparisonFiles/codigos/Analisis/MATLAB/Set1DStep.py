...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S1DStep', squeeze_me=True)
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set1DStep.png', dpi=200)
plt.show()
