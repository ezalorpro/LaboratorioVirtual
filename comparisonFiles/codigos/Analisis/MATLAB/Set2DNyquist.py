...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S2DNyquist', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Analisis/Set2DNyquist.pkl', 'rb') as f:
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set2DNyquist.png', dpi=200)
plt.show()
