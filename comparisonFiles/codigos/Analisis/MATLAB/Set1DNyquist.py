...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S1DNyquist', squeeze_me=True)
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set1DNyquist.png', dpi=200)
plt.show()
