...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S2DImp', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Analisis/Set2DImp.pkl', 'rb') as f:
    T1, Y1 = pickle.load(f)
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set2DImp.png', dpi=200)
plt.show()
