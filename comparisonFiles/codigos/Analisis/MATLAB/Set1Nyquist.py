...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S1Nyquist', squeeze_me=True)
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set1Nyquist.png', dpi=200)
plt.show()
