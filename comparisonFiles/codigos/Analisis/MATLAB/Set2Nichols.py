...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S2Nichols', squeeze_me=True)
...
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set2Nichols.png', dpi=200)
plt.show()
