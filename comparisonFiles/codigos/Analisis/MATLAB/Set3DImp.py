...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S3DImp', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Analisis/Set3DImp.pkl', 'rb') as f:
    T1, Y1 = pickle.load(f)
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set3DImp.png', dpi=200)
plt.show()
