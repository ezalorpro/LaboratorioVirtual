...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S2Rlocus', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Analisis/Set2Rlocus.pkl', 'rb') as f:
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set2Rlocus.png', dpi=200)
plt.show()
