...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S3Nyquist', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Analisis/Set3Nyquist.pkl', 'rb') as f:
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set3Nyquist.png', dpi=200)
plt.show()
