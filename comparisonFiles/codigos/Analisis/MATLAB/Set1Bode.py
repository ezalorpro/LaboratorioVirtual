...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S1Bode', squeeze_me=True)
...
axins1 = ax1.inset_axes([0.12, 0.16, 0.4, 0.4])
...
axins2 = ax2.inset_axes([0.1, 0.15, 0.36, 0.4])
