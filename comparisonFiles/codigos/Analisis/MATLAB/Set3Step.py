...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S3Step', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Analisis/Set3Step.pkl', 'rb') as f:
    T1, Y1 = pickle.load(f)
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set3Step.png', dpi=200)
plt.show()
