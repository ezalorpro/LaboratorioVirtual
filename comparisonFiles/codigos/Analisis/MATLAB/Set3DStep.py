...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S3DStep', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Analisis/Set3DStep.pkl', 'rb') as f:
    T1, Y1 = pickle.load(f)
...
ax.set_title('Respuesta escalón para el Sistema 3')
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set3DStep.png', dpi=200)
plt.show()
