...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S1Nichols', squeeze_me=True)
...
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set1Nichols.png', dpi=200)
plt.show()
