...
with open('comparisonFiles/Data LVSCCD/Analisis/Set2DMargin.pkl', 'rb') as f:
    GM1, GP1, WM1, WP1 = pickle.load(f)

with open('comparisonFiles/Data LVSCCD/Analisis/Set2DBode.pkl', 'rb') as f:
    Freq1, Mag1, Pha1 = pickle.load(f)

MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S2DBode', squeeze_me=True)
Mag2, Pha2, Freq2 = MatFile['MagB'], MatFile['PhaB'], MatFile['FreqB']

MatFile2 = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S2DMargin', squeeze_me=True)
...
ax1.legend(loc=7, bbox_to_anchor=(0.56, 0.75))
ax1.grid()

axins1 = ax1.inset_axes([0.14, 0.12, 0.4, 0.4])
...
axins2 = ax2.inset_axes([0.13, 0.12, 0.4, 0.4])
...
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set2DBode.png', dpi=200)
plt.show()
