...
with open('comparisonFiles/Data LVSCCD/Analisis/Set3DMargin.pkl', 'rb') as f:
    GM1, GP1, WM1, WP1 = pickle.load(f)

with open('comparisonFiles/Data LVSCCD/Analisis/Set3DBode.pkl', 'rb') as f:
    Freq1, Mag1, Pha1 = pickle.load(f)

MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S3DBode', squeeze_me=True)
Mag2, Pha2, Freq2 = MatFile['MagB'], MatFile['PhaB'], MatFile['FreqB']

MatFile2 = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S3DMargin', squeeze_me=True)
...
ax2.legend(loc=7, bbox_to_anchor=(0.58, 0.78))
ax2.grid()
...
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set3DBode.png', dpi=200)
plt.show()
