...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S2Nyquist', squeeze_me=True)
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set2Nyquist.png', dpi=200)
plt.show()
