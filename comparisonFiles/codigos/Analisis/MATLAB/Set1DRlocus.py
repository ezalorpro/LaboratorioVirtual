...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S1DRlocus', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Analisis/Set1DRlocus.pkl', 'rb') as f:
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set1DRlocus.png', dpi=200)
plt.show()
