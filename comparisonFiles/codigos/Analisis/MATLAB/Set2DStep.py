...
MatFile = io.loadmat('comparisonFiles/Data MATLAB/Analisis/S2DStep', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Analisis/Set2DStep.pkl', 'rb') as f:
    T1, Y1 = pickle.load(f)
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/MATLAB/Set2DStep.png', dpi=200)
plt.show()
