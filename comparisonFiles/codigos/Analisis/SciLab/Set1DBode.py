...
MatFile = io.loadmat('comparisonFiles/Data SciLab/Analisis/S1DBode', squeeze_me=True)
Mag2, Pha2, Freq2 = MatFile['MagB'], MatFile['PhaB'], MatFile['FreqB']

MatFile2 = io.loadmat('comparisonFiles/Data SciLab/Analisis/S1DMargin', squeeze_me=True)
...
plt.savefig('comparisonFiles/plots/Analisis/SciLab/ScSet1DBode.png', dpi=200)
plt.show()
