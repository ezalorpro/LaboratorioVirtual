...
MatFile = io.loadmat('comparisonFiles/Data SciLab/Analisis/S1Nyquist', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Analisis/Set1Nyquist.pkl', 'rb') as f:
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/SciLab/ScSet1Nyquist.png', dpi=200)
plt.show()
