...
MatFile = io.loadmat('comparisonFiles/Data SciLab/Analisis/S1DNyquist', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Analisis/Set1DNyquist.pkl', 'rb') as f:
...
ax.set_title('Diagrama de Nyquist para el Sistema 1')
ax.legend(loc=7, bbox_to_anchor=(0.77, 0.7))
ax.grid()

axins = ax.inset_axes([0.35, 0.17, 0.4, 0.33])
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/SciLab/ScSet1DNyquist.png', dpi=200)
plt.show()
