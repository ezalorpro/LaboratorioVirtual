...
MatFile = io.loadmat('comparisonFiles/Data SciLab/Analisis/S2Step', squeeze_me=True)
...
ax.set_title('Respuesta escalón para el Sistema 2')
ax.legend(loc=7, bbox_to_anchor=(0.97, 0.75))
ax.grid()

axins = ax.inset_axes([0.55, 0.13, 0.4, 0.37])
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/SciLab/ScSet2Step.png', dpi=200)
plt.show()
