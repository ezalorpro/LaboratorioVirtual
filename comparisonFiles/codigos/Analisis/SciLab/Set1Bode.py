...
with open('comparisonFiles/Data LVSCCD/Analisis/Set1Margin.pkl', 'rb') as f:
    GM1, GP1, WM1, WP1 = pickle.load(f)

with open('comparisonFiles/Data LVSCCD/Analisis/Set1Bode.pkl', 'rb') as f:
...
ax1 = axObj[0]
ax1.plot(Freq2, Mag2, color="#12711C", label='SciLab', linewidth=2)
...
ax1.fill_between(Freq2, Mag1, Mag2, alpha=0.4, color="#12711C", label='Area de diferencia')
ax1.set_xscale('log')
...
axins1 = ax1.inset_axes([0.12, 0.18, 0.4, 0.4])
axins1.plot(Freq2, Mag2, color="#12711C", label='SciLab', linewidth=2)
...
axins1.fill_between(Freq2, Mag1, Mag2, alpha=0.4, color="#12711C", label='Area de diferencia')
...
ax2 = axObj[1]
ax2.plot(Freq2, Pha2, color="#12711C", label='SciLab', linewidth=2)
...
ax2.legend(loc=7, bbox_to_anchor=(0.97, 0.77))
ax2.grid()

axins2 = ax2.inset_axes([0.1, 0.17, 0.36, 0.4])
axins2.plot(Freq2, Pha2, color="#12711C", label='SciLab', linewidth=2)
...
x1, x2 = Freq2[indicePha] - np.abs(Pha1[indicePha] - Pha2[indicePha])*0.02, Freq2[indicePha] + np.abs(Pha1[indicePha] - Pha2[indicePha])*0.02
...
plt.savefig('comparisonFiles/plots/Analisis/SciLab/ScSet1Bode.png', dpi=200)
plt.show()
