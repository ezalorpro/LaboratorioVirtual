...
MatFile = io.loadmat('comparisonFiles/Data SciLab/Analisis/S2Bode', squeeze_me=True)
Mag2, Pha2, Freq2 = MatFile['MagB'], MatFile['PhaB'], MatFile['FreqB']

MatFile2 = io.loadmat('comparisonFiles/Data SciLab/Analisis/S2Margin', squeeze_me=True)
...
plt.savefig('comparisonFiles/plots/Analisis/SciLab/ScSet2Bode.png', dpi=200)
plt.show()
