...
MatFile = io.loadmat('comparisonFiles/Data SciLab/Analisis/S1Imp', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Analisis/Set1Imp.pkl', 'rb') as f:
    T1, Y1 = pickle.load(f)
...
axins = ax.inset_axes([0.54, 0.34, 0.41, 0.3])
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/SciLab/ScSet1Imp.png', dpi=200)
plt.show()
