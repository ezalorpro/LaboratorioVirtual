...
MatFile = io.loadmat('comparisonFiles/Data SciLab/Analisis/S1DImp', squeeze_me=True)
...
fig.tight_layout()
plt.savefig('comparisonFiles/plots/Analisis/SciLab/ScSet1DImp.png', dpi=200)
plt.show()
