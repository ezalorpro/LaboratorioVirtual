...
MatFile = io.loadmat('comparisonFiles/Data SciLab/Analisis/S1Nichols', squeeze_me=True)

with open('comparisonFiles/Data LVSCCD/Analisis/Set1Nichols.pkl', 'rb') as f:
...
x1, x2 = Pha1[indice] - np.abs(Db1[indice] - Db2[indice])*0.1, Pha2[indice] + np.abs(Db1[indice] - Db2[indice])*0.1
...
plt.savefig('comparisonFiles/plots/Analisis/SciLab/ScSet1Nichols.png', dpi=200)
plt.show()
